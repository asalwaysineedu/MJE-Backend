...
from app.domains.landing.controller.api import landing_router
...
@app.delete("/admin/cache/candidates")
async def clear_candidate_cache():
    redis = await get_redis()
    keys = await redis.keys("candidate:area:*")
    if keys:
